      ...
      >
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <section className="lg:col-span-7">
            <section className="bg-white rounded-lg shadow-sm mb-4 sm:mb-6 md:mb-8 py-6 px-4 sm:py-8 sm:px-6 md:py-6 md:px-6">
              <section className="flex items-center justify-between w-full">
                {activeStep === "address" && (
                  <>
                    <section className="flex items-center text-black">
                      <section className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center mr-2 sm:mr-3 md:mr-4 bg-black text-white flex-shrink-0">
                    ...
                    <section className="flex items-center text-gray-400">
                      <section className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center mr-2 sm:mr-3 md:mr-4 bg-gray-300 flex-shrink-0">
                ...
                {activeStep === "payment" && (
                  <section className="flex items-center text-black justify-start w-full">
                    <section className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center mr-2 sm:mr-3 md:mr-4 bg-black text-white flex-shrink-0">
                      <CreditCard className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />
                    </section>
                    <section>
            ...
            {activeStep === "address" && (
              <section className="bg-white rounded-lg shadow-sm p-4 pb-2 sm:p-6 sm:pb-4 md:p-8 lg:p-10 xl:p-12">
          ...
          <section className="lg:col-span-5">
            <section className="bg-white rounded-lg shadow-sm p-4 sm:p-6 sticky top-6">
              <section className="hidden lg:flex justify-between items-center mb-6">
                <section>
              ...
              <section className={`${showOrderSummary ? 'block' : 'hidden'} lg:block`}>
                <section className="space-y-4 mb-6 max-h-[28rem] overflow-y-auto">
                  {items.map((item) => (
                    <section key={item.id} className="flex gap-4 p-4 border-b">
                      <section className="relative w-32 h-36 flex-shrink-0">
                        <Image
