            ...
            <section className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {[
                ...
                <section key={i} className="flex flex-col items-center">
                  <section className="w-14 h-14 rounded-full bg-[#EAEAEA] flex items-center justify-center mb-3 shadow-md">
      ...
      <Container>
        <section className="py-16 md:py-24">
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <section>
              ...
              <section className="space-y-8">
                <section className="flex items-start">
                  <section className="bg-[#EAEAEA] p-3 rounded-full mr-4">
            ...
            <section className="bg-white p-8 rounded-none  border-b border border-black">
        ...
        <Container>
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <section className="bg-white p-8 rounded-xl shadow-sm text-center">
              <section className="mx-auto w-16 h-16 bg-[#EAEAEA] rounded-full flex items-center justify-center mb-6">
