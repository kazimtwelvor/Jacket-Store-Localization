...
export default async function HomePage() {
  try {
    ...
    const features = [
      ...
      {
        title: "Gift Services",
        description: "Make your gift special with our premium gift wrapping service.",
        icon: "Gift",
        link: "/gift",
      },
      {
    ...
    return (
      <Suspense fallback={<div className="w-full h-screen flex items-center justify-center">Loading...</div>}>
        <HomePageClient billboard={billboard} products={products} showcaseItems={showcaseItems} features={features} />
      </Suspense>
    )
  } catch (error) {
