            ...
            <div>
              ...
              <div className="mt-8">
                <Button size="lg" className="mr-4 bg-[#eaeaea] hover:bg-[#f6f6f6] text-black rounded-none" asChild>
                  <Link href={`/${countryCode}/shop`}>Shop Collection</Link>
                </Button>
                <Button
                  variant="blackInvert"
                  size="lg"
                  ...
                  asChild
                >
                  <Link href={`/${countryCode}/blogs`}>Read Our Blog Articles</Link>
                </Button>
              </div>
            </div>
        ...
        <section className="py-16 md:py-24 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button size="lg" className="bg-[#EAEAEA] hover:bg-[#eaeaea] text-black rounded-none" asChild>
              <Link href={`/${countryCode}/shop`}>Explore Collection</Link>
            </Button>
            <Button
              variant="blackInvert"
              size="lg"
              ...
              asChild
            >
              <Link href={`/${countryCode}/contact-us`}>Get in Touch</Link>
            </Button>
          </div>
        </section>
      </Container>
