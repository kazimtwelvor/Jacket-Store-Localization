    ...
    >
      ...
      <div className="p-4 space-y-4">
        <p className="text-sm text-[#666666]">
          ...
          is here to help. You can also visit our <a href={`/${countryCode}/contact-us`} className="text-[#2b2b2b] underline hover:text-[#1b1b1b]">Contact Us</a> page for more information.
        </p>
