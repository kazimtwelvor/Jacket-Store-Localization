...
import PayPalCardForm from "@/src/app/components/cart/PayPalCardForm";
import GooglePayWithPaypal from "@/src/app/components/GooglePayWithPaypal";
import AfterpayExpressCheckout from "@/src/app/components/AfterpayExpressCheckout";
...
import {
  STATES_BY_COUNTRY,
  getStatesForCountry,
} from "@/src/app/utils/states-data";
import { trackBeginCheckout,clearCheckoutTracking } from "@/src/app/lib/analytics";
...
const CheckoutPage = () => {
  ...
  const handlePaymentSuccess = async () => {
    ...
    setTimeout(() => {
      setPaymentModal({ isOpen: false, status: "processing", message: "" });
      clearCart();
      router.push(`/${countryCode}/checkout/confirmation?orderId=${orderId}&success=1`);
    }, 2000);
  };
                  ...
                  <>
                    ...
                    <div className="flex items-center text-black">
                      ...
                      <div className="min-w-0">
                        <h2 className="font-bold text-sm sm:text-base md:text-lg truncate text-black">
                          ADDRESS
                        </h2>
                    ...
                    {/* Payment Step - Available or Disabled */}
                    <div 
                      onClick={() => {
                    ...
                    >
                      <div className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center mr-2 sm:mr-3 md:mr-4 flex-shrink-0 transition-all duration-200 ${
                        isAddressComplete 
                          ? "bg-gray-200 hover:bg-gray-300" 
                          : "bg-gray-100"
                      }`}>
                        <CreditCard className={`w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 ${
                          isAddressComplete ? "text-gray-600" : "text-gray-400"
                        }`} />
                      </div>
                      <div className="min-w-0">
                        ...
                        <p className={`text-xs sm:text-sm hidden sm:block ${
                          isAddressComplete ? "text-gray-500" : "text-gray-400"
                        }`}>
                ...
                {activeStep === "payment" && ( // Payment step is active
                  <>
                    ...
                    <div 
                      ...
                      className="flex items-center text-gray-600 hover:text-black transition-all duration-200 cursor-pointer"
                    >
                      <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center mr-2 sm:mr-3 md:mr-4 bg-gray-200 hover:bg-gray-300 flex-shrink-0 transition-all duration-200">
                        <Truck className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-gray-600" />
                      </div>
                      <div className="min-w-0">
                        <h2 className="font-bold text-sm sm:text-base md:text-lg truncate text-gray-600">
                          ADDRESS
                        </h2>
              ...
              <div className="bg-white rounded-lg shadow-sm p-4 pb-2 sm:p-6 sm:pb-4 md:p-8 lg:p-10 xl:p-12">
                <form className="space-y-6">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-600">Enter your delivery information below</p>
                  </div>
                  ...
                  <div className="border-t border-gray-200 pt-6 mt-8">
                    <div className="mb-4">
                      ...
                      <p className="text-sm text-gray-600">Choose whether to use the same address for billing</p>
                    </div>
                    
                    <label className="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-200 hover:bg-gray-100 transition-colors">
                      <input
                        type="checkbox"
                    ...
                    {!formData.billingAddressSame && (
                      <div className="space-y-6 mt-6 p-6 bg-white border border-gray-200 rounded-lg">
                        <div className="mb-4">
                          <h4 className="text-md font-medium text-gray-900 mb-2">Billing Information</h4>
                          <p className="text-sm text-gray-600">Enter your billing address details</p>
                        </div>
                  ...
                  <div className="border-t border-gray-200 pt-6 mt-8">
                    ...
                    <div className="space-y-3">
                      <label className="flex items-center justify-between p-4 bg-gray-50 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
                        <div className="flex items-center">
                          <input
                            type="radio"
                            name="shippingMethod"
                            ...
                            onChange={handleInputChange}
                            className="h-4 w-4 text-[#B01E23] focus:ring-[#B01E23] border-gray-300"
                          />
                          <div className="ml-3">
                  ...
                  <div className="border-t border-gray-200 pt-6 mt-8">
                    <div className="mb-4">
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">Acknowledgement</h3>
                    ...
                    <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                      <label className="flex items-start cursor-pointer">
                        <input
                          ...
                          onChange={handleInputChange}
                          className="h-5 w-5 text-[#000000] focus:ring-[#000000] border-gray-300 rounded mt-0.5 flex-shrink-0"
                        />
                        <span className="ml-3 text-sm text-gray-700 leading-relaxed">
                          ...
                          {" "}of this website and understand that my personal information will be processed according to these policies.
                        </span>
                      </label>
                    </div>
                  </div>
                    ...
                    <div className="group">
                      <div className={`p-6 border-2 rounded-xl transition-all duration-200 ${
                        ...
                        <label className="cursor-pointer mb-4">
                          ...
                          <div className="flex items-center justify-start md:justify-start ml-10 md:ml-10">
                            <img
                 ...
                 <div className="mb-8 p-4 border border-gray-200 rounded-lg">
                   <div className="flex justify-between items-center mb-4">
                     ...
                     <button
                       ...
                       className="flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-md transition-colors duration-200 border border-blue-200 hover:border-blue-300"
                     >
