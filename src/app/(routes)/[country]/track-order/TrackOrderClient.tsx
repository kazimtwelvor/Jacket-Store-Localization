      ...
      <div className="container mx-auto px-4 max-w-4xl mt-[35px]">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href={`/${countryCode}/shipping-and-delivery-policy`} className="block p-4 border border-gray-200 rounded-lg hover:border-gray-300 transition-colors">
            ...
            <a href={`/${countryCode}/refund-and-returns-policy`} className="block p-4 border border-gray-200 rounded-lg hover:border-gray-300 transition-colors">
            ...
            <a href={`/${countryCode}/contact-us`} className="block p-4 border border-gray-200 rounded-lg hover:border-gray-300 transition-colors">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mt-8">
          ...
          <div className="space-y-4">
            ...
            <div className="border-b border-gray-200 pb-4">
              ...
              <p className="text-gray-600">Standard shipping typically takes 3-4 business days. You can view detailed shipping information on our <a href={`/${countryCode}/shipping-and-delivery-policy`} className="text-blue-600 hover:underline">Shipping Policy</a> page.</p>
            </div>
            <div className="border-b border-gray-200 pb-4">
              <h3 className="font-semibold text-gray-900 mb-2">What if my order shows as delivered but I haven't received it?</h3>
              <p className="text-gray-600">Please check with neighbors, building management, or other household members. If you still can't locate your package, <a href={`/${countryCode}/contact-us`} className="text-blue-600 hover:underline">contact our support team</a> within 48 hours.</p>
            </div>
            <div className="border-b border-gray-200 pb-4">
              <h3 className="font-semibold text-gray-900 mb-2">Can I change my shipping address after placing an order?</h3>
              <p className="text-gray-600">Address changes are only possible if your order hasn't been processed yet. Please <a href={`/${countryCode}/contact-us`} className="text-blue-600 hover:underline">contact us immediately</a> if you need to update your shipping address.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">What should I do if my tracking shows no updates?</h3>
              <p className="text-gray-600">Tracking information may take 24-48 hours to update after shipping. If there are no updates after this time, please reach out to our <a href={`/${countryCode}/contact-us`} className="text-blue-600 hover:underline">customer service team</a> for assistance.</p>
            </div>
          </div>
        </div>
