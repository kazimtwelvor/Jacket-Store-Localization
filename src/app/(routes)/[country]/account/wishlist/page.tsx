...
import TrendingProducts from "@/src/app/components/account/wishlist/trending-products-client"
...
export default function WishlistPage() {
  ...
  }, [isAuthenticated, router, countryCode])
            ...
            <div className="w-full md:w-64 mb-6 md:mb-0">
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="flex flex-col space-y-1">
                  ...
                  <Link
                    href={`/${countryCode}/account/my-data`}
                    className="py-2 px-4 hover:bg-gray-100 rounded text-sm uppercase font-medium flex items-center"
                  >
                    <span>My Data</span>
                  ...
                  <Link
                    href={`/${countryCode}/account/preferences`}
                    className="py-2 px-4 hover:bg-gray-100 rounded text-sm uppercase font-medium flex items-center"
                  >
