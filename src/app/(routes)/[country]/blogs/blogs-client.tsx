          ...
          {filteredPosts.length === 0 ? (
            ...
            <div id="posts-container" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {currentlyVisiblePosts.map((post) => (
                <Link href={`/${countryCode}/blogs/${post.slug || post.id}`} key={post.id} className="group">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="border-b border-gray-200 pb-6">
                ...
                <p className="text-muted-foreground">Absolutely! We love hearing from our readers. <a href={`/${countryCode}/contact-us`} className="text-blue-600 hover:underline">Contact us</a> with your topic suggestions, and our editorial team will consider them for upcoming articles.</p>
              </div>
              <div className="border-b border-gray-200 pb-6">
