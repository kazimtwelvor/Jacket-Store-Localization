...
import { User, Sliders, Package, Heart, ArrowRight, Clock, XCircle, Truck, Calendar } from "lucide-react"
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex-1 md:ml-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                <div className="flex items-center">
                  <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mr-6 shadow-md">
                    <Package className="h-10 w-10 text-black" strokeWidth={1.5} />
                  </div>
                  <div>
                ...
                <div className="flex">
                  <button
                    className={`py-3 px-6 font-medium text-sm uppercase ${
                      activeTab === "online" ? "bg-black text-white" : "bg-white text-black hover:bg-gray-100"
                    }`}
                  ...
                  <button
                    className={`py-3 px-6 font-medium text-sm uppercase ${
                      activeTab === "retail" ? "bg-black text-white" : "bg-white text-black hover:bg-gray-100"
                    }`}
              ...
              <div className="py-4">
                  ...
                  <>
                    {isLoading ? (
                      ...
                      <div className="text-center py-12">
                        <Package className="mx-auto h-16 w-16 text-gray-400 mb-4" strokeWidth={1} />
                        <p className="text-gray-600">You have not placed any orders yet.</p>
                        <Link href="/" className="mt-4 inline-block px-4 py-2 bg-black text-white rounded-md">
                          Start Shopping
                        </Link>
                      </div>
                    ) : (
                ...
                {activeTab === "retail" && (
                  <div className="text-center py-12">
                    <p className="text-gray-600">You have not placed any retail orders yet.</p>
                  </div>
                )}
              </div>
            </div>
