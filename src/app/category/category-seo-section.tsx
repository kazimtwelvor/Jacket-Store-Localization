        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <div className="lg:col-span-2">
            <h2 className="text-3xl font-bold mb-6 text-gray-900">
              Explore Our <span className="text-[#2b2b2b]">{categoryName}</span>{" "}
              Collection
            </h2>

            <HtmlRenderer
              content={
                categoryContent?.mainContent ||
                `<p>Discover our premium collection of ${categoryName.toLowerCase()} designed with quality and style in mind.</p>`
              }
            ...
            <details className="mt-8">
              ...
              >
                Learn more about our {categoryName.toLowerCase()}{" "}
                <ArrowRight className="ml-2 h-4 w-4" />
              </summary>
      <HtmlRenderer
  content={
    categoryContent?.learnMoreContent || 
    `<p>Additional information about our ${categoryName.toLowerCase()} collection.</p>`
  }
...
/>
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {(categoryContent?.faqs && categoryContent.faqs.length > 0
              ? categoryContent.faqs
              : [
                  {
                    question: "What sizes are available?",
                    answer: `Our ${categoryName.toLowerCase()} collection is available in a range of sizes from XS to XXL, ensuring a perfect fit for everyone.`,
                  },
                  {
                    question: `How do I care for my ${categoryName.toLowerCase()}?`,
                    answer:
                      "We recommend following the care instructions on each product label for optimal longevity and to maintain the quality of your items.",
                  },
                  {
                    question: "What is your return policy?",
                    answer:
                      "We offer a 30-day return policy on all items. Products must be in original condition with tags attached for a full refund.",
                  },
                  {
                    question: "Do you ship internationally?",
                    answer:
                      "Yes, we ship to most countries worldwide. Shipping times and costs vary depending on location.",
                  },
                ]
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-wrap gap-2">
            {(categoryContent?.popularSearches &&
            categoryContent.popularSearches.length > 0
              ? categoryContent.popularSearches
              : [
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-wrap gap-2">
            {(categoryContent?.selectedBlogs &&
            categoryContent.selectedBlogs.length > 0
              ? categoryContent.selectedBlogs
              : [
                  ...
                  {
                    blogTitle: `Choosing the Right ${categoryName}`,
                    blogSlug: "#",
                  },
