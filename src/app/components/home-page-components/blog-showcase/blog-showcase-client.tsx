...
export default function BlogsShowcaseClient({ blogItems, countryCode = "us" }: BlogsShowcaseClientProps) {
  ...
  }, [isDragging, mouseStart, currentIndex, visibleItems, blogItems.length]);
      ...
      <div className="w-full max-w-[1896px] py-0 m-0 pl-4 md:pl-8 lg:pl-12">
        ...
        >
          ...
          <p className="text-gray-600 max-w-3xl mx-auto px-4 text-lg leading-relaxed">
            Discover our latest articles, insights, and stories that matter. Stay informed with our expert perspectives on industry trends and innovations.
          </p>
        </motion.div>
