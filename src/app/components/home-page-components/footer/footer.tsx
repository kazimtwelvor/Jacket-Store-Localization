                    ...
                    <div className="flex flex-col md:flex-row items-center mb-4 md:mb-0">
                        ...
                        <div className="flex space-x-3">
                            <div className="w-10 h-10 bg-[#2b2b2b] rounded-full flex items-center justify-center">
                                <Link
                                    href="https://www.instagram.com/fineystjackets/"
                            ...
                            <div className="w-10 h-10 bg-[#2b2b2b] rounded-full flex items-center justify-center">
                                <Link
                                    href="https://www.facebook.com/fineystjackets"
                                    className="p-2 hover:opacity-70 transition-opacity"
                                    target="_blank"
                                    rel="noopener noreferrer"
                            ...
                            <div className="w-10 h-10 bg-[#2b2b2b] rounded-full flex items-center justify-center">
                                <Link
                                    href="https://x.com/fineystjackets"
                                    className="p-2 hover:opacity-70 transition-opacity"
                                    target="_blank"
                                    rel="noopener noreferrer"
                            ...
                            <div className="w-10 h-10 bg-[#2b2b2b] rounded-full flex items-center justify-center">
                                <Link
                                    href="https://www.pinterest.com/fineystjackets/"
                                    className="p-2 hover:opacity-70 transition-opacity"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="Follow us on Pinterest"
                                >
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-[#dedddd]">
