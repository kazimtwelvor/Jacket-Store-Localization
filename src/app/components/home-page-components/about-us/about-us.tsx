...
const AboutSection = () => {
    return (
        <section className="py-12 md:py-20 lg:py-24 bg-white relative overflow-hidden">
            <section className="absolute inset-0 opacity-[0.02]">
            ...
            <section className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <section className="text-center mb-16 md:mb-20">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-black mb-6 tracking-tight" style={{ fontFamily: 'AvertaPe, sans-serif' }}>
                        ABOUT <span className="text-[#2b2b2b] relative">
                            FINEYST
                            <section className="absolute -bottom-2 left-0 right-0 h-1 bg-[2b2b2b]"></section>
                        </span>
                    </h2>
                ...
                <section className="max-w-4xl mx-auto">
                    <section className="bg-gradient-to-br from-gray-50 to-white p-8 md:p-10 rounded-3xl shadow-sm border border-gray-100">
                        <section className="space-y-6">
                            <section className="flex items-center space-x-3 mb-6">
                                <section className="w-2 h-2 bg-[#2b2b2b] rounded-full"></section>
